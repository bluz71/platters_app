        ...
        <div className="MiscPage">
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                The Bootstrap framework, a mobile first front-end library,
                rebuilt for React.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p>
                ...
                DOM animation library. These components are used to animate
                effects such as the Artists search form <em>slide-down</em>{' '}
                motion.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p>
                ...
                library affords artist and album comments to be displayed using
                Twitter-like local-time-ago timestamps.
              </p>
            </li>
            <li>
              <h3>
          ...
          <ul>
            ...
            <li>
              ...
              <p>An opinionated code JavaScript code formatter.</p>
            </li>
          </ul>
          <br />
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                Form submission buttons, such as the Albums filter{' '}
                <em>Select</em> button, will display a spinner icon whilst the
